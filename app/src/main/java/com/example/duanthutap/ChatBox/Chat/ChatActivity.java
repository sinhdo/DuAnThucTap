package com.example.duanthutap.ChatBox.Chat;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getImg != null && !getImg.isEmpty()) {
            Picasso.get().load(getImg).into(profilePic);
        } else {
    ...
    // Hàm để tìm chat key dựa trên hai ID người dùng
    ...
    // Hàm để tạo một chat mới nếu không tìm thấy chat thỏa mãn
